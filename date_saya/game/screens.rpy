...
style window:
    ...
    background Image("gui/textbox.png", xalign=0.5, yalign=1.25)
...
define gui.name_text_bold = True
...
define gui.choice_button_width = 982
define gui.choice_button_height = 61
define gui.choice_button_borders = Borders(10, 15, 10, 15)
